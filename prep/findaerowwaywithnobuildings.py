...
parser = optparse.OptionParser(
   description='Finds all aeroway = \'terminal\' ways without a building=* way. '
   ...
   usage='findareowaywithnobuildings.py [options] [outputfile.osm]')
...
sql = ('select way ' 
       ...
       'where '
       '  way1.aeroway = \'terminal\' and '
       'not exists '
       '  (select * '
       '   from planet_osm_polygon as way2 '
       '   where way2.building != \'\' and ST_Intersects(way1.way,way2.way) '
       '  )')
